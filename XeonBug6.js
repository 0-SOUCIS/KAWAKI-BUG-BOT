...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot By KAWAKI ${ownername}`).catch(_ => _)
        }
...
senddocu(buffer)
        ...
        switch (command) {
            ...
            case 'shutdown':
                if (!isCreator) return replygcxeon(mess.owner)
                replygcxeon(`Bye bye petit papillon`)
                await sleep(3000)
                process.exit()
                break
            case 'restart':
                ...
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://telegra.ph/file/ff624750770874db01daa.mp4',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube @KA-WA-KI-`,
                            thumbnailUrl: 'https://telegra.ph/file/ff624750770874db01daa.mp4',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
